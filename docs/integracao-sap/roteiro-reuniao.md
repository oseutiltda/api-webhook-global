...
2. Qual endpoint/transacao/BAPI oficial para cada dominio?
3. Existe ambiente de homologacao com dados e credenciais separadas?
4. Como funciona autenticacao (OAuth, Basic, certificado, SAP user) e renovacao?
5. Existe versionamento de contrato e politica de breaking change?

### Regras por operacao
6. Quais campos obrigatorios para `create`, `update`, `cancel`, `settle`?
7. Quais campos nao podem ser alterados apos integracao?
8. Quais pre-condicoes existem para cancelamento de nota de saida/entrada?
9. Para baixas (CP/CR), quais chaves financeiras obrigatorias?
10. Para GNRE/NF entrada, qual objeto SAP correto e validacoes fiscais?

### Idempotencia, retorno e reconciliacao
11. Qual chave de negocio o SAP usa para deduplicacao/idempotencia?
12. Como consultar status de processamento assincrono?
13. Qual identificador SAP devemos armazenar para reconciliacao?
14. Existe API/relatorio para reconciliar por periodo/chave?

### Operacao e confiabilidade
15. Quais codigos de erro sao transitorios vs permanentes?
16. Qual timeout e SLA esperado por operacao?
17. Existe rate limit / limite de throughput?
18. Qual estrategia recomendada para reprocessamento/rollback?
19. Quais logs/auditoria SAP podem ser acessados pelo time tecnico?
20. Quais criterios minimos para aprovacao de go-live por dominio?
