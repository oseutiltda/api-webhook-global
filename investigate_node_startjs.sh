...
if [ -f "/opt/API-WEBHOOK-BMX/frontend/start.js" ]; then
    echo "Arquivo encontrado: /opt/API-WEBHOOK-BMX/frontend/start.js"
    echo "Primeiras 50 linhas:"
    head -50 /opt/API-WEBHOOK-BMX/frontend/start.js
    echo ""
    echo "Últimas 20 linhas:"
    tail -20 /opt/API-WEBHOOK-BMX/frontend/start.js
else
