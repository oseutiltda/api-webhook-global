...
router.post('/faturas/pagar/criar', verifyWebhookSecret, ensureIdempotency, controller.faturaPagarCriar);
router.post('/faturas/pagar/baixar', verifyWebhookSecret, ensureIdempotency, controller.faturaPagarBaixar);
router.post('/faturas/pagar/cancelar', verifyWebhookSecret, ensureIdempotency, controller.faturaPagarCancelar);
router.post('/faturas/receber/criar', verifyWebhookSecret, ensureIdempotency, controller.faturaReceberCriar);
router.post('/faturas/receber/baixar', verifyWebhookSecret, ensureIdempotency, controller.faturaReceberBaixar);
